...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ci'=>'string|required|unique:clients|min:7|max:10',
            'phone'=>'string|required|unique:clients|min:8|max:12',
            'email'=>'string|nullable|unique:clients|max:255|email:ric,dns',
